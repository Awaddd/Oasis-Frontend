...
const META = <Meta title="Omar Dini | Terms and Conditions" description="Omar Dini's personal blog" />
...
const TermsAndConditions: FC = () => (
  <Main meta={META}>
    <section className="prose mt-lg mb-lg md:mx-auto">
      ...
      <p>
        These terms and conditions outline the rules and regulations for the use of Omardini.com's Website, located at
        https://omardini.co.uk.
      </p>
      <p>
        By accessing this website we assume you accept these terms and conditions. Do not continue to use Omardini.com
      ...
      <p>
        We employ the use of cookies. By accessing Omardini.com, you agreed to use cookies in agreement with the
        Omardini.com's Privacy Policy.{" "}
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, Omardini.com and/or its licensors own the intellectual property rights for all material
        on Omardini.com. All intellectual property rights are reserved. You may access this from Omardini.com for your
      ...
      <p>
        ...
        areas of the website. Omardini.com does not filter, edit, publish or review Comments prior to their presence on
        the website. Comments do not reflect the views and opinions of Omardini.com,its agents and/or affiliates.
        Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted
        by applicable laws, Omardini.com shall not be liable for the Comments or for any liability, damages or expenses
        caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this
        website.
      </p>
      <p>
        Omardini.com reserves the right to monitor all Comments and to remove any Comments which can be considered
      ...
      <p>
        You hereby grant Omardini.com a non-exclusive license to use, reproduce, edit and authorize others to use,
      ...
      <p>
        ...
        Omardini.com; and (d) the link is in the context of general resource information.
      </p>
      <p>
      ...
      <p>
        ...
        you must inform us by sending an e-mail to Omardini.com. Please include your name, your organization name,
      ...
      <p>
        No use of Omardini.com's logo or other artwork will be allowed for linking absent a trademark license agreement.
      </p>
      <h3>
