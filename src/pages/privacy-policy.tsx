...
const META = <Meta title="Omar Dini | Privacy Policy" description="Omar Dini's personal blog" />
...
const PrivacyPolicy: FC = () => (
  <Main meta={META}>
    <section className="prose mt-lg mb-lg md:mx-auto">
      ...
      <p>
        At Omardini.com, accessible from https://omardini.co.uk, one of our main priorities is the privacy of our
        visitors. This Privacy Policy document contains types of information that is collected and recorded by
        Omardini.com and how we use it.
      </p>
      <p>
      ...
      <p>
        ...
        to the information that they shared and/or collect in Omardini.com. This policy is not applicable to any
      ...
      <h2>Log Files</h2>
      <p>
        Omardini.com follows a standard procedure of using log files. These files log visitors when they visit websites.
      ...
      <p>
        ...
        in their respective advertisements and links that appear on Omardini.com, which are sent directly to users'
      ...
      <p>
        Note that Omardini.com has no access to or control over these cookies that are used by third-party advertisers.
      </p>
      <h2>Third Party Privacy Policies</h2>
      <p>
        Omardini.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
      ...
      <p>
        Omardini.com does not knowingly collect any Personal Identifiable Information from children under the age of 13.
