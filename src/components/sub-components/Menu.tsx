...
const BasicMenu: FC<Props> = ({ label, data }) => {
  ...
  return (
    <Menu as="div" className="relative hidden text-left md:inline-block">
      <div>
        <Menu.Button className="inline-flex items-center justify-center w-full px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm text hover:bg-gray-50 focus:outline-none" id="menu-button">
          {label}
