  ...
  return (
    <div className="bg-[#304ffe] rounded-md px-lg py-lg lg:px-xl md:px-[45px] lg:py-[45px]">
      <main className="flex flex-col justify-between gap-5 lg:gap-10 lg:flex-row 2xl:gap-16">
        <article className="">
          <h2 className="text-3xl font-bold leading-9 text-gray-200">{title}</h2>
          {subtitle && <p className="font-semibold text-gray-300">{subtitle}</p>}
        ...
        <form className="flex flex-col lg:self-end md:flex-row">
          <input
            id="email"
            type="text"
            className="px-3 py-2 text-gray-700 bg-white border placeholder-gray-900 border-gray-300 rounded-[4px] focus:border-blue-500 focus:outline-none focus:ring xl:w-96"
