...
const SocialIconBar = ({ dark }: { dark?: boolean }) => {
  ...
  return (
    <>
      ...
      <a className="mt-[1px]" href="#" aria-label="Email">
        <svg className={`fill-current h-[2.4rem] w-[2.4rem] ${variant}`} version="1.1" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
